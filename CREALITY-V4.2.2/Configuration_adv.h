...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X 46.52f       // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y 30.61f       // (Hz) The default dominant resonant frequency on the Y axis.
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_TIMEOUT_SEC 20 // (seconds)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_MIN_Z_CHANGE 0.20 // (mm) Minimum Z change before saving power-loss data
