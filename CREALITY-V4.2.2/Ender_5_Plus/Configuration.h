...
#define STRING_CONFIG_H_AUTHOR "(T.Temourtzidis, Creality Ender-5 Plus)" // Original author or contributor.
...
#define PID_MAX 250 // Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
...
#define NOZZLE_TO_PROBE_OFFSET {-34, -14, 0} // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
