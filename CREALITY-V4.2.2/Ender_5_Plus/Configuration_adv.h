...
#else
#define ADVANCE_K 0.1 // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
#endif
...
#define MMU3_LOAD_TO_NOZZLE_SEQUENCE                                                             \
    ...
    {                                                                                            \
        _MMU_EXTRUDER_HEATBREAK_LENGTH, MMM_TO_MMS(198)                                          \
    } /* ( 3.3 mm/s) Slow load after heatbreak */
