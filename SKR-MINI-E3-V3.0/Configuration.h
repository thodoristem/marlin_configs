...
#define CONFIG_EXAMPLES_DIR "config/examples/Creality/Ender-5 Pro/BigTreeTech SKR Mini E3 3.0"
...
#define STRING_CONFIG_H_AUTHOR "(T.Temourtzidis, Ender-5 Pro)" // Who made the changes.
...
#define MAX_BED_POWER 250 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 166.08
  #define DEFAULT_bedKi  32.44
  #define DEFAULT_bedKd 566.89
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36, -16, 0 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 10, 10, 10, 10 } // (mm) Left, Front, Right, Back insets
